class Collision:
    ...
    def test_collision_dyn(self, c, vitesse):
        """
        Vérifie les collisions en tenant compte des vitesses.
        Ajuste la vitesse pour éviter une collision si nécessaire.
        """
...
if __name__ == "__main__":
    ...
    c1 = Collision(position=[15, 20], size=[2, 2])
    c2 = Collision(position=[5, 20], size=[2, 2])

    # Définition de la vitesse initiale
    vitesse_c2 = [3, 0]  # c2 se déplace vers la droite
