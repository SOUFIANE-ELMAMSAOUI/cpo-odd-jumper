...
class Entity:
    def __init__(self,MAX_SPEED = [0, 0], vitesse= [0, 0], name = "", path_image = "", position= [0, 0], size = [50, 50],fenetre = None,harmful = False, collect = False, talking = {"cond":False}):
        ...
        if self.talking:
            ...
            self.text = text = self.font.render(talking["text"], False, (0, 0, 0))
